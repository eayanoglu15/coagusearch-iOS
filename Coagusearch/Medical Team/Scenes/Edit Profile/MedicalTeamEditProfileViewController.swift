//
//  MedicalTeamEditProfileViewController.swift
//  Coagusearch
//
...
extension MedicalTeamEditProfileViewController: MedicalTeamEditProfileDataSourceDelegate {
    func routeToProfile() {
        navigationController?.popViewController(animated: true)
    }
}

class MedicalTeamEditProfileViewController: BaseScrollViewController {
    var dataSource = MedicalTeamEditProfileDataSource()
...
extension MedicalTeamEditProfileViewController: UITextFieldDelegate {
