//
//  MedicalTeamEditPatientViewController.swift
//  Coagusearch
//
...
import UIKit
 ...
 extension MedicalTeamEditPatientViewController: MedicalTeamEditPatientDataSourceDelegate {
    func popView() {
...
class MedicalTeamEditPatientViewController: BaseScrollViewController {
    ...
    var dataSource = MedicalTeamEditPatientDataSource()
    ...
    override func viewDidLoad() {
        ...
        stylize()
        title = "Patient Information".localized
        // Do any additional setup after loading the view.
    ...
    @IBAction func removePatientButtonTapped(_ sender: Any) {
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        guard let name = nameTextField.text, !name.isEmpty, let surname = surnameTextField.text, !surname.isEmpty else {
            showAlertMessage(title: "Missing Information".localized, message: "Please enter your name and surname.".localized)
            return
        }
        var birthDay: Int?
        var birthMonth: Int?
        ...
        dataSource.savePatientInfo(name: name, surname: surname, birthDay: birthDay, birthMonth: birthMonth, birthYear: birthYear, height: height, weight: weight, bloodType: bloodType, rhType: rhType, gender: gender)
    }
...
extension MedicalTeamEditPatientViewController: UITextFieldDelegate {
