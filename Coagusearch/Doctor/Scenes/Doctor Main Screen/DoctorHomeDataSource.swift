...
class DoctorHomeDataSource {
    ...
    var selectedEmergencyPatientId: Int?
    
    func setSelectedEmergencyPatientId(id: Int) {
        selectedEmergencyPatientId = id
    }
    
    func getSelectedEmergencyPatientId() -> Int? {
        if let id = selectedEmergencyPatientId {
            return id
        }
        return nil
    }
